...
"""
# Bilibili Monitor - 部署说明
# --------------------------------------------------
# 1. GitHub: https://github.com/qi-1021/bilibili_monitor
# 2. Hugging Face: https://huggingface.co/spaces/isqi/bilibili_monitor
# 3. Gitee AI: https://gitee.com/isqi1021/bilibili_monitor
# --------------------------------------------------
# 同步方式:
# 在本地项目根目录运行 `sh sync_all.sh` 即可一键同步至以上所有平台。
"""
